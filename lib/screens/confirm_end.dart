...
class ConfirmEndScreen extends StatefulWidget {
  ConfirmEndScreen({ Key key }) : super(key: key);

  @override
  _ConfirmEndScreenState createState() => _ConfirmEndScreenState();
}

class _ConfirmEndScreenState extends State<ConfirmEndScreen> {
                ...
                children: [
                  ...
                  Expanded(
                    child: LoxButton(
                      ...
                      onTap: ()=>Navigator.pushNamed(context, routeEndMessage),
                    ),
                  ),
                ],
              ),
